$(document).ready(function() {
            ...
            // Variable to track if all reviews are currently displayed
            var allReviewsDisplayed = false;

            // Function to toggle between showing all reviews and just the first four
            function toggleReviews() {
                var reviews = $(".review-container");

                if (allReviewsDisplayed) {
                    // Hide all reviews except the first four
                    reviews.slice(4).hide();
            ...
            // Add a click event listener to the "Show more reviews" button
