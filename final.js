...
function populatePropertyDetails(property) {
    ...
    // Check if amenities is not null or undefined before displaying
    if (amenities) {
    ...
    document.querySelector(".data-map-lat").textContent = `Latitude: ${latitude}`;
    document.querySelector(".data-map-lon").textContent = `Longitude: ${longitude}`;
