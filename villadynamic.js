    ...
    function populatePropertyDetails(property) {
        ...
        document.querySelector(".property-id").textContent = `${propertyId}`;
                    ...
                    document.querySelector(".amenities").textContent = `Amenities: ${amenities}`;
    ...
    // Get the DOM element where you want to display amenities
    const amenitiesElement = document.querySelector(".amenities");

    // Clear any existing content in the amenities element
    amenitiesElement.innerHTML = '';

    // Create a list (ul) to display amenities
    const amenitiesList = document.createElement('ul');

    // Iterate through the amenities array and create list items (li) for each amenity
    ...
    // Append the list of amenities to the amenities element
